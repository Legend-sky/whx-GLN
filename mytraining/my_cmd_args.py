...
cmd_opt.add_argument('-save_dir', default='mytraining/train1', help='result output root')
cmd_opt.add_argument('-dropbox', default="/home/dell/whx/whx-GLN/dropbox", help='dropbox folder')
...
cmd_opt.add_argument('-data_name', default='schneider50k', help='dataset name')
cmd_opt.add_argument('-tpl_name', default='default', help='template name')
...
cmd_opt.add_argument('-epochs2save', default=50, type=int, help='epochs to save')
...
cmd_opt.add_argument('-topk', default=50, type=int, help='topk eval')
cmd_opt.add_argument('-neg_num', default=64, type=int, help='num of negative samples')
cmd_opt.add_argument('-beam_size', default=50, type=int, help='beam search size')
cmd_opt.add_argument('-gm', default='mean_field', help='choose gnn module')
cmd_opt.add_argument('-fp_degree', default=2, type=int, help='fingerprint? [>0, 0]')
...
cmd_opt.add_argument('-gen_method', default='weighted', help='none/uniform/weighted')
...
cmd_opt.add_argument('-iters_per_val', default=3000, type=int, help='number of iterations per evaluation')
cmd_opt.add_argument('-batch_size', default=64, type=int, help='batch size for training')
cmd_opt.add_argument('-retro_during_train', type=eval, default=True, help='doing retrosynthesis during training?')
